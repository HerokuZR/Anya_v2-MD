...
module.exports = {
    ...
    mongoUrl: process.env.MongoDB || "mongodb://mongo:UxVIjEDkBxCySBsnbzPYQBebAmxvzbjg@junction.proxy.rlwy.net:17429",
    sessionId: process.env.SESSION_ID || "Fu93DSAS#REOYweYsbhX5Jwa2X5vrht_WQpKrReGGeZEg5olWZJQ",
